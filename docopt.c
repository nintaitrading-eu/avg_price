...
"\n"
"Usage:\n"
"    avg_price [--verbose] --dataset=<shares_int1,price_double1;...;shares_intn,price_doublen>\n"
"    avg_price --help\n"
"    avg_price --version\n"
"\n"
"Options:\n"
"    --dataset                   String with a ;-separated list of shares_int,price_double pairs.\n"
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_options; i++) {
        ...
        } else if (!strcmp(option->olong, "--dataset")) {
            if (option->argument)
                args->dataset = option->argument;
        }
    }
    /* commands */
